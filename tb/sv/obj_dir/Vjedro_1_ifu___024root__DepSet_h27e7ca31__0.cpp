...
void Vjedro_1_ifu___024root___eval_triggers__act(Vjedro_1_ifu___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vjedro_1_ifu___024root___eval_triggers__act\n"); );
    // Body
    vlSelf->__VactTriggered.set(0U, (vlSelf->jedro_1_addi_tb__DOT__dut__DOT__alu_inst__DOT__less_than_unsign_32b_inst__DOT__w2 
                                     != vlSelf->__Vtrigprevexpr___TOP__jedro_1_addi_tb__DOT__dut__DOT__alu_inst__DOT__less_than_unsign_32b_inst__DOT__w2__1));
    vlSelf->__VactTriggered.set(1U, (vlSelf->jedro_1_addi_tb__DOT__dut__DOT__alu_inst__DOT__less_than_sign_32b_inst__DOT__less_than_unsign_31b_inst__DOT__w2 
    ...
    vlSelf->__VactTriggered.set(2U, ((IData)(vlSelf->jedro_1_addi_tb__DOT__clk) 
                                     & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__jedro_1_addi_tb__DOT__clk__0))));
