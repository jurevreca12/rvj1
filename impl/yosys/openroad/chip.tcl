# Based on croc flow: 
# https://github.com/pulp-platform/croc/blob/main/openroad/scripts/chip.tcl
...
# helper scripts
source openroad/reports.tcl
source openroad/checkpoint.tcl

# initialize technology data
source openroad/init_tech.tcl
...
read_sdc openroad/constraints.sdc
...
source openroad/power_connect.tcl

utl::report "Create Floorplan"
source openroad/floorplan.tcl

utl::report "Create Power Grid"
source openroad/power_grid.tcl
...
write_def                      output/${proj_name}.def
write_verilog -include_pwr_gnd -remove_cells "$stdfill bondpad*" output/${proj_name}_lvs.v
write_verilog                  output/${proj_name}.v
write_db                       output/${proj_name}.odb
write_sdc                      output/${proj_name}.sdc
...
# write_spef output/${proj_name}.spef
# read_spef  output/${proj_name}.spef; # readback parasitics for OpenSTA
