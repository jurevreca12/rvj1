...
source openroad/floorplan_util.tcl
...
set chipH    700; # OR die height (top to bottom)
set chipW    700; # OR die width (left to right)
set padD       0; # pad depth (edge to core)
set padW       0; # pad width (beachfront)
set padBond    0; # bonding pad size
set powerRing  40; # reserved space for power ring
...
utl::report "Place Pins"
place_pins -hor_layers Metal3 -ver_layers Metal2
utl::report "Placed pins succesfully"

##########################################################################
# Paths to the instances of macros
##########################################################################
utl::report "Macro Names"
#source openroad/instances.tcl
