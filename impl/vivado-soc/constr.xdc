...
# ---------------------------------------------------------------------------- 
set_property -dict {PACKAGE_PIN Y9 IOSTANDARD LVCMOS33} [get_ports { clk_i }];  # "GCLK"
...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property -dict {PACKAGE_PIN T22 IOSTANDARD LVCMOS33} [get_ports {gpio_out[0]}];  # "LD0"
set_property -dict {PACKAGE_PIN T21 IOSTANDARD LVCMOS33} [get_ports {gpio_out[1]}];  # "LD1"
set_property -dict {PACKAGE_PIN U22 IOSTANDARD LVCMOS33} [get_ports {gpio_out[2]}];  # "LD2"
set_property -dict {PACKAGE_PIN U21 IOSTANDARD LVCMOS33} [get_ports {gpio_out[3]}];  # "LD3"
set_property -dict {PACKAGE_PIN V22 IOSTANDARD LVCMOS33} [get_ports {gpio_out[4]}];  # "LD4"
set_property -dict {PACKAGE_PIN W22 IOSTANDARD LVCMOS33} [get_ports {gpio_out[5]}];  # "LD5"
set_property -dict {PACKAGE_PIN U19 IOSTANDARD LVCMOS33} [get_ports {gpio_out[6]}];  # "LD6"
set_property -dict {PACKAGE_PIN U14 IOSTANDARD LVCMOS33} [get_ports {gpio_out[7]}];  # "LD7"
...
# ---------------------------------------------------------------------------- 
set_property -dict {PACKAGE_PIN P16 IOSTANDARD LVCMOS33} [get_ports {rst}];  # "BTNC"
